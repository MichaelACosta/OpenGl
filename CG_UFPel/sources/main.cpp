...
int main(void)
{
    ...
    do{
        ...
        glm::vec3 lightColor1 = glm::vec3(1, 1, 0);
        glm::vec3 lightColor2 = glm::vec3(1, 0, 0);
        glm::vec3 lightColor3 = glm::vec3(0, 1, 0);

        currentTime = glfwGetTime();
        if (currentTime-lastTime>=3 && currentTime-lastTime<6) {
            lightColor1 = glm::vec3(0, 1, 0);
            lightColor2 = glm::vec3(1, 1, 0);
            lightColor3 = glm::vec3(1, 0, 0);
        } else if (currentTime-lastTime>=6 && currentTime-lastTime<9) {
            lightColor1 = glm::vec3(1, 0, 0);
            lightColor2 = glm::vec3(0, 1, 0);
            lightColor3 = glm::vec3(1, 1, 0);
        } else if (currentTime-lastTime>=9) {
